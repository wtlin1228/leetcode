...
If multiple vowels have the same **frequency**, order them by the
position of their **first occurrence** in `s`.
...
- Thus, they retain their relative order based on first occurrence,
  and the string remains unchanged.
